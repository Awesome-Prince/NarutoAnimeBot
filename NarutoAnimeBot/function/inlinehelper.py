...
from NarutoAnimeBot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from NarutoAnimeBot.pyrogramee.pluginshelper import fetch
from NarutoAnimeBot import pgram as pbot

ARQ_API = 'MTXJXE-ELSWXE-UDRXJC-JCJQXN-ARQ'
BOT_USERNAME = "NarutoAnimeBot"
ARQ_API_KEY = ARQ_API
SUDOERS = OWNER_ID
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/NarutoAnimeBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Naruto✨](https://github.com/IzumiCypherX/NarutoAnimeBot):**
**MainBot:** `{bot_state}`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
"""
