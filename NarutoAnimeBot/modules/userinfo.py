...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nɪᴛ's ᴍʏ ʟᴇɢᴇɴᴅ ɪ ᴍᴇᴀɴ VALT AOI OWNER "
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis Person is a Developer of VALT AOI"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThis Person is a Sudo-User of VALT AOI"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis Person is a Support User of VALT AOi"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis User is Immune to all Restrictions over VALT AOI"
        disaster_level_present = True
