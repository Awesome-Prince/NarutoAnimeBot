...
buttons = [
    [
        InlineKeyboardButton(
            text="༒ 𝙰𝙳𝙳 POKE ROBOT 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 ༒",url="t.me/NarutoTheAnimeBot?startgroup=true"
        ),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        ...
        InlineKeyboardButton(
          text="★ 𝙲𝙷𝙴𝙲𝙺 𝙼𝚈 𝙵𝚁𝙸𝙴𝙽𝙳 ★", url="https://t.me/Devil_the_Robot"
        ),
    ],
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
           Naruto_IMG, caption= "<code> ₱Ø₭Ɇ ⱤØ฿Ø₮ ✗LY ʜᴇʀᴇ ғᴏʀ ʏᴏᴜ❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime
            ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "₱Ø₭Ɇ ⱤØ฿Ø₮ ✗LY IS BACK TO ONLINE")
        except Unauthorized:
            LOGGER.warning(
